...
<html lang="en">
  ...
  <a class="navbar-brand" href="index.html">CrowdFundr</a>
  ...
  <fieldset >
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 offset-sm-3 float-md-right">
                            <div class="form-group row">
                                <label for="example-search-input" class="col-12 col-form-label">Following</label>
                                <div class="col-10">
                                    <a href="">Opt out of Following</a><br />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="example-email-input" class="col-12 col-form-label">Security</label>
                                <div class="col-10">
                                    <a href="">Verify Your Email Enable Up Two Factor </a><br />
                                    <a href="">Authentication </a><br />
                                    <a href="">Log me out on all other devices</a><br />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <a href="">Delete my Crowdfunding account</a><br />
                                </div>
                            </div>
...
<div class="row">
    ...
    <li><a href="account-payment.html">Payment methods</a></li>
    <li><a href="/about.html">Glossary</a></li>
    <li><a href="/about.html">Blog</a></li>
				...
				<div class="col-4 col-md-3">
					...
					<li><a class="transition-all navy-400 hover-navy-500" href="typography.html">Typography</a></li>
					<li><a class="transition-all navy-400 hover-navy-500" href="contact.html">Support</a></li>
					<li><a class="transition-all navy-400 hover-navy-500" href="typography.html">Terms of Use</a></li>
					<li><a class="transition-all navy-400 hover-navy-500" href="typography.html">Privacy Policy</a></li>
					<li><a class="transition-all navy-400 hover-navy-500" href="typography.html">Cookie Policy</a></li>
					</ul>
				</div>
