...
<html lang="en">
  ...
  <link rel="canonical" href="http://127.0.0.1:8000/account-payment">
...
<h1>Settings</h1><br /><br />
    <ul class="nav nav-tabs hidden-sm-down">
      ...
      <li class="nav-item active">
        <a class="nav-link active" href="http://127.0.0.1:8000/account-payment">Payment methods</a>
      </li>
      ...
      <li class="nav-item ">
        <a class="nav-link " href="start">Create new ad</a>
      </li>
...
<div class="btn-group  btn-block  btn-group-justified hidden-md-up" role="group" aria-label="Button group with nested dropdown">
  <div class="btn-group   btn-block" role="group">
    ...
    <div class="dropdown-menu"  style="width: 100%" aria-labelledby="btnGroupDrop1">
        ...
        <li class="nav-item ">
            <a class="nav-link " href="http://127.0.0.1:8000/ahttp://127.0.0.1:8000/ccount-notifications">Notifications</a>
        </li>
...
<br />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <p>Any payment methods you save to CrowdFundr will be listed here (securely) for your convenience. To save a card for future pledges, just click "Add a new card."</p>
                                </div>
