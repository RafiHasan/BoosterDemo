...
<html lang="en">
  ...
  <link rel="canonical" href="http://127.0.0.1:8000/project">
...
$id=session()->get('projectview');

$pro=$id[0][0];

//foreach ($id[0] as $use) {
//if($use->id==$id[1]->profileid)
	//$pro=$use;
//}
...
$basic=$id[1][0];
					...
					echo	'<div class="col-sm-10">
							<h3>'.$basic->projecttitle.'</h3>
							<br />
							<p class="mb-1">'.$basic->fundraised*100/$basic->fundinggoal.'% funded</p>
							<div class="progress">
								<div class="progress-bar" role="progressbar" style="width: '.$basic->fundraised*100/$basic->fundinggoal.'%" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100"></div>
							</div>


							<div class="row">
								<div class="col-sm-6">
									<h3>$'.$basic->fundraised.'</h3>
									<p class="mb-1">backed by 132 people</p>
								</div>
								<div class="col-sm-6 text-right">
									<h3>$'.$basic->fundinggoal.'</h3>
							...
							<iframe width="100%" height="350" src="'.$basic->projectvideo.'" frameborder="0" allowfullscreen></iframe>
...
?>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link disabled" href="#backers" role="tab">BACKERS (797)</a>
						</li>
					</ul>
					<br />
					<br />
						...
						<div class="card-block" class="pb-1">
							<div class="row ">
								<div class="col-sm-12">
									...
									<div class="row ">
										<div class="col-sm-5">
											<a href=""><img src="'.$pro->Picture.'" class="img-fluid rounded-circle" /></a>
											<br />
											<br />
										</div>
										<div class="col-sm-6">
											<h3 class="mb-0"><strong>'.$pro->FirstName.'</strong></h3>
...
<form  action = "/abouts/'.$basic->id.'" method = "get"  >
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
        ...
        <div class="form-group light-blue">
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <textarea rows="1" class="form-control" name="cash" required></textarea>
            </div>
...
<input type = '.$submit.' class="btn btn-lg btn-primary btn-block" value = "Back this project"/>
									...
									<br />
									<p>This project will only be funded if at least $'.$basic->fundinggoal.' is pledged within '.$basic->fundingduration.' days</p>
