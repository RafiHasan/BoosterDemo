...
<html lang="en">
  ...
  <link rel="canonical" href="http://127.0.0.1:8000/account-profile">
  ...
  <a class="navbar-brand" href="http://127.0.0.1:8000/index">CrowdFundr</a>

  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto" >
      <li class="nav-item active">
        <a class="nav-link" href="http://127.0.0.1:8000/index">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="http://127.0.0.1:8000/explore">Explore</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="http://127.0.0.1:8000/edit">Start a project</a>
      </li>
      <li class="nav-item">
...
<h1>Settings</h1><br /><br />
    <ul class="nav nav-tabs hidden-sm-down">
      ...
      <li class="nav-item ">
        <a class="nav-link " href="http://127.0.0.1:8000/account-dashboard">Account</a>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link active" href="http://127.0.0.1:8000/account-profile">My profile</a>
      </li>
      ...
      <li class="nav-item ">
        <a class="nav-link " href="http://127.0.0.1:8000/account-notifications">Notifications</a>
      </li>
      ...
      <li class="nav-item ">
        <a class="nav-link " href="http://127.0.0.1:8000/account-payment">Payment methods</a>
      </li>
      ...
      <li class="nav-item ">
        <a class="nav-link " href="http://127.0.0.1:8000/start">Create new ad</a>
      </li>
                    ...
                    <div class="row">
                        <div class="col-sm-5 ">
                            <div class="form-group row">
                                ...
                                <div class="col-9 col-md-10">
                                    <input class="form-control" type="text" value="firstname@example.com" id="example-text-input">
                        ...
                        <div class="col-sm-5 offset-sm-1 float-md-right">
                            <div class="form-group row">
                                ...
                                <div class="col-9 col-md-10">
                                    <input class="form-control" type="search" value="London, UK" id="example-search-input">
                                    <p class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                <label for="example-email-input" class="col-3 col-md-2 col-form-label">Timezone</label>
                                <div class="col-9 col-md-10">
                                    <input class="form-control" type="text" value="GMT" id="example-email-input">
                                    <p class="form-text text-muted">
                                        Most time zones are automatically adjusted for you. We'll use this setting for emails.
                                    </p>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="example-url-input" class="col-3 col-md-2 col-form-label">Profile&nbsp;URL</label>
                                <div class="col-9 col-md-10">
                                    <input class="form-control" type="url" value="" id="example-url-input">
                                    <p class="form-text text-muted">
                                        For example, if you'd like your URL to be www.example.com/profile/polarbear, just type polarbear! Choose wisely though, once you set your vanity URL, it can't be reset.
                                    </p>
                                </div>
                            </div>
