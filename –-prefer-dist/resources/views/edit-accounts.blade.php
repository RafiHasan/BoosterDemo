...
<html lang="en">
  ...
  <link rel="canonical" href="http://127.0.0.1:8000/edit-accounts">
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      <ul class="breadcrumb">
        ...
        <li><a href="http://127.0.0.1:8000/edit-about">About you</a></li>
        <li><a href="http://127.0.0.1:8000/edit-accounts">Account</a></li>
      </ul>
...
<br />
              ...
              <div class="row mt-3">
                <div class="col-12">
                    <a href="http://127.0.0.1:8000/edit" class="btn btn-primary pull-right">Save</a>
...
<nav class="navbar fixed-bottom navbar-light bg-faded" style="background: #fff; border-top: 1px solid #eee">
  <div class="container">
    ...
    <a href="http://127.0.0.1:8000/edit" class="btn btn-primary btn-lg float-right">Save campaign</a>
    <a href="http://127.0.0.1:8000/edit" class="btn btn-link btn-lg float-right">Discard changes</a>
