...
<html lang="en">
  ...
  <link rel="canonical" href="http://127.0.0.1:8000/account-notifications">
...
<h1>Settings</h1><br /><br />
    <ul class="nav nav-tabs hidden-sm-down">
      ...
      <li class="nav-item ">
        <a class="nav-link " href="http://127.0.0.1:8000/account-profile">My profile</a>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link active" href="http://127.0.0.1:8000/account-notifications">Notifications</a>
      </li>
...
<div class="btn-group  btn-block  btn-group-justified hidden-md-up" role="group" aria-label="Button group with nested dropdown">
  <div class="btn-group   btn-block" role="group">
    ...
    <div class="dropdown-menu"  style="width: 100%" aria-labelledby="btnGroupDrop1">
        ...
        <li class="nav-item ">
            <a class="nav-link " href="http://127.0.0.1:8000/account-phttp://127.0.0.1:8000/ayment">Payment methods</a>
        </li>
                             ...
                             <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-8">
                                            <p>A new answer has been posted on a question you follow</p>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-8">
                                            <p>A daily digest of any follows or upvotes on your posts</p>
                                        </div>
                             ...
                             <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-8">
                                            <p>Advice and guidance to help you run your project</p>
                                        </div>
