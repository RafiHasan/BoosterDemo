									...
									<div class="card-block">
										...
										<div class="row ">
												...
												<div class="col-sm-6">
													...
													<h4 class="display-8"><a href="http://127.0.0.1:8000/project">I'm making a Potato salad</a></h4>
                ...
                <div class="col-3 carousel-list">
					<div class="row">
						...
						<ul class="nav flex-column justify-content-end text-right ">
  						  ...
  						  <li class="nav-item">
							<a class="nav-link" href="#art" data-slide="1">  Art</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#comics" data-slide="2">  Comics</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#crafts" data-slide="3">  Crafts</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#dance" data-slide="4">  Dance</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#design" data-slide="5">  Design</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#fashion" data-slide="6">  Fashion</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#film-video" data-slide="7">  Film & Video</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#food" data-slide="8">  Food</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#games" data-slide="9">  Games</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#journalism" data-slide="10">  Journalism</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#music" data-slide="11">  Music</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#photography" data-slide="12">  Photography</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#publishing" data-slide="13">  Publishing</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#technology" data-slide="14">  Technology</a>
						  </li>
						
  						  <li class="nav-item">
							<a class="nav-link" href="#theater" data-slide="15">  Theater</a>
						  </li>
						
						<li class="nav-item">
							<a class="nav-link" href="/explore">View all categories</a>
						  </li>
						</ul>
                	</div>      
                	</div>      
	...
	foreach ($id[0] as $pro) {
		if($pro->id==$use->profileid)
			$pro2=$pro;
						...
						echo	'<div class="swiper-slide" data-hash="art">
								<div>
								<h2>Staff picks:<span class="text-primary">Art</span></h2><br />
								<div class="cardd ">
...
<a href="/about/'.$use->id.'" class="thumbnaidl"><img height="80" width="100" style="height: 100%; width: 100%;" class="img-fluid" src="'.$use->projectimage.'" /></a>
												...
												<div class="col-sm-6">
													...
													<h4 class="display-8"><a href="/about/'.$use->id.'">'.$use->projecttitle.'</a></h4>
													<p class="text-muted">By <strong><a href="/about/'.$use->id.'" class="text-muted">'.$pro2->FirstName.'</a></strong> in <strong>London, UK</strong></p>
													<p>'.$use->shortblurb.'</p>
											
<br />
													<div class="progress">
  <div class="progress-bar" role="progressbar" style="width: '.$use->fundraised*100/$use->fundinggoal.'%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
</div>
<p>'.$use->fundraised*100/$use->fundinggoal.'% funded</p>
												</div>
										</div>
									</div>
										...
										<div class="row ">
												<div class="col-sm-12">
													<div class="row ">
														<div class="col">
															<p class="mt-0 mb-0">Pledged</p>
															<h5 class="mt-0 mb-0">&dollar;'.$use->fundraised.'</h5>
														</div>
														<div class="col">
															<p class="mt-0 mb-0">Backers</p>
															<h5 class="mt-0 mb-0">250</h5>
														...
														<div class="col">
															<p class="mt-0 mb-0">Funding goal</p>
															<h5 class="mt-0 mb-0">&dollar;'.$use->fundinggoal.'</h5>
														</div>
													</div>
												</div>
											</div>
...
<div class="card-footer text-muted">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 250px;">
				...
				<h6><a href="http://127.0.0.1:8000/project">iterate plug-and-play metrics</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Chris Adams</a></strong></p>
...
<div class="card-footer text-muted">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 250px;">
				...
				<h6><a href="http://127.0.0.1:8000/project">architect best-of-breed niches</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Ronald Spencer</a></strong></p>
...
<div class="card-footer text-muted">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 250px;">
				...
				<h6><a href="http://127.0.0.1:8000/project">iterate impactful interfaces</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Ruth Diaz</a></strong></p>
...
<div class="mt-5">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 250px;">
				...
				<h6><a href="http://127.0.0.1:8000/project">envisioneer viral functionalities</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Alice Long</a></strong></p>
...
<div class="card-footer text-muted">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 250px;">
				...
				<h6><a href="http://127.0.0.1:8000/project">incubate next-generation platforms</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Jane Simmons</a></strong></p>
...
<div class="card-footer text-muted">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 250px;">
				...
				<h6><a href="http://127.0.0.1:8000/project">grow strategic schemas</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Nicole Green</a></strong></p>
...
<div class="card-footer text-muted">
	...
	<div class="card-block" class="pb-1" style="position: relative; padding-bottom: 60px; min-height: 50px;">

				<h6><a href="http://127.0.0.1:8000/project">incubate plug-and-play vortals</a></h6>
				<p class="text-muted">By <strong><a href="http://127.0.0.1:8000/project" class="text-muted">Annie Stevens</a></strong></p>
...
<div class="row">
    ...
    <li><a href="/aboutus">Partners</a></li>
    <li><a href="/account-payment">Payment methods</a></li>
    <li><a href="/aboutus">Glossary</a></li>
