...
<html lang="en">
  ...
  <link rel="canonical" href="http://127.0.0.1:8000/edit-perks">
...
<p>Invite backers to be a part of the creative experience by offering rewards like a copy of what you’re making, a special experience, or a behind-the-scenes look into your process.</p>
 ...
 <form  action = "/edit-perksdata/" method = "post">
...
<div class="form-group row">
  ...
  <div class="col-9">
    <input class="form-control" type="text" value="" placeholder="" id="example-text-input" name="title" required>
  </div>
</div>
<div class="form-group row">
  <label for="example-search-input" class="col-3 col-form-label">Pledge amount</label>
  <div class="col-9">
    <input class="form-control" type="text" value="" id="example-search-input" name="pledgeamount" required>
  </div>
</div>
<div class="form-group row">
  <label for="example-email-input" class="col-3 col-form-label">Description</label>
  <div class="col-9">
    <textarea class="form-control" rows="6" type="text" value="" id="example-email-input" name="description" required></textarea>
  </div>
</div>
<div class="form-group row">
  <label for="example-url-input" class="col-3 col-form-label">Estimated&nbsp;delivery</label>
  <div class="col-9">
    <input class="form-control" type="text" value="" id="example-url-input" name="estimateddelivery" required>
  </div>
</div>
<div class="form-group row">
  <label for="example-tel-input" class="col-3 col-form-label">Shipping details</label>
  <div class="col-9">
    <input class="form-control" type="tel" value="" id="example-tel-input" name="shippingdetails" required>
  </div>
</div>
